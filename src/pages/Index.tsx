...
const Index = () => {
  ...
  const founders = [{
    ...
    bio: "With 8 years of leadership in B2B SaaS Mobility Tech, Andreas has led over 10 digital ventures as a Venture Architect. As Co-Founder & CEO of MOBIKO, he built an award-winning corporate mobility platform and successfully closed a Series A investment round. He has an extensive industry network to fleet management providers and mobility consulting firms, and serves as a board member of the bfp Forum."
  }, {
